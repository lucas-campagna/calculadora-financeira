  ...
  <div class="max-w-4xl mx-auto">
    ...
    {#if hasResults && showResults}
      <div class="mt-6 space-y-6">
        <ResultsSummary />
        <ComparisonChart onselectdata={openExtraPayment} />
        <AmortizationTable onrowclick={openExtraPayment} />
      </div>
    {/if}
  </div>
...
{#if isDev}
  <div class="fixed top-4 left-4 z-50 flex gap-2">
    <button
      onclick={toggleTheme}
      class="h-12 w-12 rounded-full bg-gray-800 dark:bg-gray-200 text-white dark:text-gray-800 shadow-lg flex items-center justify-center hover:bg-gray-700 dark:hover:bg-gray-300 transition-opacity"
